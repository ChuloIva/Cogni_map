...
# Only using the three required tasks: Forward Belief, Forward Action, and Backward Belief
VARIABLES = ['forward_belief', 'forward_action', 'backward_belief']
# Only using true_belief and false_belief conditions (6 total conditions)
