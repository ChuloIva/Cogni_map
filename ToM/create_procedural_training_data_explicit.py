...
This version uses ONLY explicit belief conditions (1_ prefix).

This script:
1. Loads forward_belief examples from 1_ prefix conditions (explicit beliefs)
...
def sample_training_data(
    ...
    """
    Sample training examples from 1_ prefix forward_belief conditions ONLY.
    ...
    # Define the 2 conditions to sample from (ONLY 1_ prefix - explicit beliefs)
    conditions = [
    ...
    training_pairs = []
    metadata = {
        'condition_type': 'explicit_beliefs',
        'prefix': '1',
...
def main():
    ...
    print("=" * 80)
    print("Creating ToM Training Dataset - EXPLICIT BELIEFS (1_ prefix)")
    print("=" * 80)
    print(f"\nConditions directory: {conditions_dir}")
    print(f"Output directory: {output_dir}\n")

    # Sample training data
    print("Sampling training examples from 1_ prefix conditions...")
    print("  - 700 examples from 1_forward_belief_false_belief")
    print("  - 700 examples from 1_forward_belief_true_belief")
    print()
    ...
    # Save training data
    training_data_path = output_dir / 'procedural_training_data_explicit.json'
    ...
    # Save metadata
    metadata_path = output_dir / 'procedural_training_metadata_explicit.json'
